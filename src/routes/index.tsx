...
const PROUD = [
  ...
  { emoji: "🏠", title: "STRONG", body: "despite ur npd parents, still, YOU CHOSE to grow into someone gentle, careful, and loving. you became the home you needed." },
  ...
  { emoji: "🍇", title: "LET HER COOK", body: "girl everytime u send that picture, its always looks delishh cant wait to cook together w u hereeee." },
...
const GOOD = [
  ...
  "ALSO GENEROUS AS FUCK (MAY YOU GET RICHERRR)",
  "girlboss",
  "you make people feel safe around you.",
  "you always know the right thing to say.",
  "YOU GIVE THE BEST ADVICE BUT NEVER FOLLOW YOUR OWN ADVICE.",
  "you are so easy to talk to.",
  "your existence is comforting.",
  "you never make me feel judged.",
  "you make effort. a LOT of effort.",
  "ASBUN NYA TUH DILUAR NALAR",
  "you have excellent taste in literally everything.",
  "soft spoken aw",
  "the wisest around",
  "consideret apa si bahasa inggrisnya itulah",
  ...
  "A BEAUTIFUL ARTIST",
  "AO3 final boss.",
  "SHAKESPEARE BEEN REAL QUIET SINCE YOU STARTED WRITING.",
  "your academic validation levels are through the roof.",
  "you learn things ridiculously fast.",
  "secretly good at everything BUT acts surprised when other notice.",
  "INISIATIF",
  "MULTITALENTA TRALALA TRILILI",
  "HARDWORKER",
  "CUNT",
  "you are the definition of girls girllll .",
  "YOU ARE SOOOOO EASY TO LOVE.",
  "MOTHERRRRRRRRRRRRRRRRRRRRRRRRRR",
];
